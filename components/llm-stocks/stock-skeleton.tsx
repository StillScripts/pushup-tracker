export const StockSkeleton = () => {
	return (
		<div className="rounded-xl border border-zinc-900 bg-zinc-950 p-4 text-green-400">
			<div className="float-right inline-block w-fit rounded-full bg-white/10 bg-zinc-700 px-2 py-1 text-xs text-transparent">
				xxxxxxx
			</div>
